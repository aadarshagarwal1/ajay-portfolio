      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            I'm currently pursuing MSc Management Consultancy at UCD Smurfit and 
            targeting sales roles across Dublin's SaaS and technology sector.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="p-4 bg-primary/10 border border-primary/20 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Open to Sales Development Representative and revenue operations opportunities in Dublin
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-muted-foreground">
                    <p className="font-medium text-primary">UCD Michael Smurfit Graduate Business School</p>
                    <p>MSc Management Consultancy</p>
                    <p>Sep 2024 – Aug 2025 | GPA: 3.6</p>
                  </div>
                </div>
